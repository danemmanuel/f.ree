        ...
        <section class="navigation">
            <header>
                <div class="header-content">
                    <div class="logo"><a href="#"><img src="img/logofreebranco.png" alt="Sedna logo" style="max-width:150px"></a></div>
                    <div class="header-nav">
                        <nav>
                            ...
                            <ul class="member-actions">
                                <li><a href="login" class="btn-white btn-small">Entrar/Cadastrar</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="navicon">
